...
class Demo {
  ...
  _addGLTFModel(gltf) {
    ...
    this._gltfObject.position.z = -5;
    this._gltfObject.position.y = 1;
    this._gltfObject.scale.copy(new THREE.Vector3(4, 4, 4));
  ...
  _drawController(gripMatrix) {
    ...
    if(this._heartDragged) {
        ...
        this._gltfObject.applyQuaternion(diffYRotation.inverse());
    }
  }
